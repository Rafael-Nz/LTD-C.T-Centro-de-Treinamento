...
<body class="d-flex flex-column min-vh-100">
  ...
  <main class="flex-fill d-flex" id="mainContent">
    <div class="container-lg p-4 d-flex flex-column flex-fill">
      ...
      <div class="card border-0 p-2 shadow-sm mb-4">
          ...
          <div class="d-flex gap-2 align-items-center flex-wrap">
            ...
            <div class="dropdown-center">
              ...
              <ul class="dropdown-menu p-3 dropdown-menu-lg" style="min-width: 320px;">
                <p class="h6 text-start" style="font-size: 0.875rem">Modalidade</p>
                <li>
                  <select id="filtroModalidadeSelect" class="form-select">
                ...
                <li class="d-grid">
                  <button id="aplicarFiltrosTreinos" class="btn btn-sm btn-red">Aplicar Filtros</button>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="card-body">
          <table id="tabelaTreinos" class="table table-hover align-middle w-100 mb-0" aria-label="Lista de Treinos">
            <thead>
              <tr>
                <th scope="col" class="text-start">Nome</th>
                <th scope="col" class="text-start">Modalidade</th>
  ...
  <script src="/ctt/js/admin/datatable/treinos.js"></script>
</body>
</html>